...
class TestPalmprint(unittest.TestCase):
    ...
    def test_findKPoints(self):
        ...
        plt.plot([1, 12], [4, 13], color='red', linestyle='-', linewidth=2)
        plt.scatter(*res_1, color='green', marker='o')
        plt.xlabel('X')
        plt.ylabel('Y')
        plt.title('Intersection Point Visualization')
        plt.show()
        '''
        ...
        '''
        # Plot the contour image and the line connecting the given points
        plt.imshow(img_2, cmap='gray')
        plt.plot([4, 28], [7, 25], color='red', linestyle='-', linewidth=2)
        plt.scatter(*res_2, color='green', marker='o')
        plt.xlabel('X')
        plt.ylabel('Y')
        plt.title('Intersection Point Visualization')
        plt.show()
